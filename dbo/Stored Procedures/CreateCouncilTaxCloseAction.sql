--EXEC CreateCouncilTaxCloseAction '8C009AA7-FD3D-C79A-6D36-08D11B00469E','testuser',NULL,'17D348D8-A08D-CE7A-CB8C-08CF81794A86'



CREATE procedure CreateCouncilTaxCloseAction @pCandidateId UNIQUEIDENTIFIER, @pAssigneeName varchar(50),@pActionComment varchar(50), @pCountryId UNIQUEIDENTIFIER  
...
set @TranslaionIds = (select TranslationId from Translation where KeyName = 'CouncilTaxChanges')    
