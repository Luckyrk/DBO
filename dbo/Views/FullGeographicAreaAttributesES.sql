CREATE VIEW [dbo].FullGeographicAreaAttributesES
 AS 
...
) AS Source PIVOT (MAX([Value]) FOR [Key] IN ( [CCAA], [Habitat10], [Habitat16], [HabitatMetro], [Isla], [Municipio], [PoblacionTotal], [Provincia], [Region])) AS PivotTable