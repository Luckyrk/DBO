CREATE VIEW [dbo].[Frozen_Individual_GT]    
AS    
WITH TEMP AS    
(    
...
[I612] as Iduso_internet, [I613] as Idlocal_internet,[I608] AS TipoSalud           
FROM     
(    
...
(    
MAX(src.Value)    
FOR src.[Key] IN ([I601],[I604],[I607],[I605],[I609],[I610],[I602],[I606],[I603],[I612],[I613],[I608])    
) PVT; 

GO

--GRANT SELECT ON [Frozen_Individual_GT] TO GPSBusiness
