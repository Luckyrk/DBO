CREATE VIEW [dbo].[Frozen_Paineis_Domicilios_CL_DeletedRecords]  
AS   
select DISTINCT  
...
'E' as Tipo_Envio,pl.AuditDate AS GPSUpdateTimestamp   
from   
GPS_PM_Latam_Audit.audit.panelist pl  
...
AND RNO=1  
where c.CountryISO2A='CL'AND pl.__$operation=1 AND pl.AuditOperation='D' 
