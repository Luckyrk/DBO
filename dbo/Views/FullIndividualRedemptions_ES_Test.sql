...
CREATE VIEW [dbo].[FullIndividualRedemptions_ES_Test]
AS
...
INNER JOIN IncentiveAccount AS b ON b.IncentiveAccountId = a.GUIDReference -- 191353
...
INNER JOIN IncentiveAccountTransactionInfo AS d ON d.IncentiveAccountTransactionInfoId = c.TransactionInfo_Id --5369427
