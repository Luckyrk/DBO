...
CREATE VIEW [dbo].[Frozen_Individual_BR]      
AS      
WITH TEMP AS      
(      
...
[I612] as Iduso_internet, [I613] as Idlocal_internet,[I614] as [Color de piel],[I611] AS TamanhoPe,[I608] AS TipoSalud,[Homemaker] AS [Ama De Casa]  
FROM       
(      
...
(      
MAX(src.Value)      
FOR src.[Key] IN ([I601],[I604],[I607],[I605],[I609],[I610],[I602],[I606],[I603],[I612],[I613],[I614],[I611],[I608],[Homemaker])      
) PVT; 
GO

--GRANT SELECT ON [Frozen_Individual_BR] TO GPSBusiness
