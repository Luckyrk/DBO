...
CREATE VIEW [dbo].[FullMainShoppersID]
AS
...
EXEC sys.sp_addextendedproperty @name=N'Description', @value=NULL , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'FullMainShoppersID'
GO
