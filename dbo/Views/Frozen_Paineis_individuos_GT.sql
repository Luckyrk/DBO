GO
CREATE VIEW [dbo].[Frozen_Paineis_individuos_GT]  
AS  
select DISTINCT  
...
--EXEC sys.sp_addextendedproperty @name=N'Description', @value=N'Gives Panellist details like panel code ,signup date, drop out date , reason ' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'Frozen_Paineis_individuos_GT'
--GO
