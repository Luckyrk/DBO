CREATE VIEW FullIndividualIncentives_Reports_ES
AS 
SELECT DISTINCT
     C.CountryISO2A
	,Ind.IndividualId
...
GO
--GRANT SELECT ON FullIndividualIncentives_Reports_ES TO GPSBusiness
--GRANT SELECT ON FullIndividualIncentives_Reports_ES TO GPSBusiness_Full
--GO