...
/****** Object:  View [dbo].[Frozen_HouseHold_PE]    Script Date: 03/05/2017 14:39:42 ******/
SET ANSI_NULLS ON
GO
...
GO
 ...
 CREATE VIEW [dbo].[Frozen_HouseHold_PE]      
 AS      
...
WHERE r.CountryID = (SELECT CountryID FROM Country WHERE CountryISO2A = 'PE')
AND t.KeyName = 'HomeAddressType'


GO

GRANT SELECT ON [Frozen_HouseHold_PE] TO GPSBusiness
