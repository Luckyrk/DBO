...
CREATE VIEW PanelistTransactions_MY
AS
...
WHERE C.CountryId='0C830016-18DA-4364-BB0F-4CC8B291ACB7'
)
...
--GRANT SELECT ON [PanelistTransactions_MY] TO GPSBusiness
--GRANT SELECT ON [PanelistTransactions_MY] TO GPSBusiness_Full
GO