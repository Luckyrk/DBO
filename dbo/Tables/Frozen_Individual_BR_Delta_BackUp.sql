CREATE TABLE [dbo].[Frozen_Individual_BR_Delta_BackUp](
    ...
    [Color de piel] NVARCHAR(800) NULL
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]

GO
ALTER TABLE [dbo].[Frozen_Individual_BR_Delta_BackUp] ADD  DEFAULT ((1)) FOR [isUpdated]
GO